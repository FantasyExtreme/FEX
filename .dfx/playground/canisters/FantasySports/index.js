...
import { idlFactory } from './FantasySports.did.js';
export { idlFactory } from './FantasySports.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_FANTASYSPORTS;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./FantasySports.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the FantasySports canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./FantasySports.did.js")._SERVICE>}
 */
export const FantasySports = createActor(canisterId);
