...
export const canisterId = process.env.CANISTER_ID_FANTASYFOOTBALL;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./fantasyfootball.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the fantasyfootball canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./fantasyfootball.did.js")._SERVICE>}
 */
export const fantasyfootball = createActor(canisterId);
