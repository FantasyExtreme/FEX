...
export type AdminSettings = Array<[Key, AdminSetting__1]>;
...
export interface FantasyFootball {
  ...
  'addNewMatches' : ActorMethod<
    ...
    { 'err' : Array<[boolean, string]>, 'succ' : Array<[boolean, Match]> }
  >,
  'addParticipant' : ActorMethod<
    [Key__1, Key__1, bigint],
  ...
  'changePaymentMethod' : ActorMethod<[], undefined>,
  'deleteAdminSetting' : ActorMethod<[string], [] | [AdminSetting]>,
  'finishMatch' : ActorMethod<[MatchScore], Result_2>,
  'getAdminSetting' : ActorMethod<[string], [] | [AdminSetting]>,
  ...
  'getContestReward' : ActorMethod<[], [] | [AdminSetting]>,
